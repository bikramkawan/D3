...
var points = [[10, 20], [80, 20], [100, 20], [100, 80], [100, 100], [10, 100]];
...
function updateMenu() {
    ...
    u
        ...
        .append('div')
        .classed('item', true)
        .style('clear', function(d) {
            return d.clear ? 'left' : 'none';
        })
        .text(function(d) {
            return d.name;
        })
        ...
        .style('background-color', function(d, i) {
            return d.active ? colorScale(i) : '#fff';
        })
        .style('color', function(d, i) {
            return d.active ? 'white' : '#444';
        });
}
